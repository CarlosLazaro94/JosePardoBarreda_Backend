...
import { DepartamentoRepository, ProvinciaRepository, DistritoRepository } from '../repositories'
import { DepartamentoController, ProvinciaController, DistritoController } from '../controllers'
